...
public class Pinyin4jUtil {
     ...
     * @return
     */
    public static String getPinyinZh_CN(Set<String> stringSet, String separate) {
     ...
     * @return
     */
    public static String getPinyinConvertJianPin(String chinese, String separate) {
